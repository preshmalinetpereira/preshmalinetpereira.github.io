        ...
        <div className="max-w-7xl mx-auto flex lg:flex-row flex-col items-center lg:justify-between justify-center gap-y-4 md:px-16 px-6 py-16">
          ...
          <div className="flex flex-col lg:items-end items-center lg:text-start text-center">
            <a
              ...
              href="https://github.com/preshmalinetpereira"
              target="_blank"
              rel="noreferrer noopener"
            >
              <BiLogoGithub />
              Repositories <em className="text-primary-color not-italic">33</em>
            </a>

            <small className="text-zinc-500">
              Copyright &copy; Linet Preshma Pereira {new Date().getFullYear()} All rights Reserved | Designed by Victor Eke
            </small>
          </div>
        </div>
      </footer>
